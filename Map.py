# Modification of James Spencer <jamessp [at] gmail.com>'s
# simple python dungeon generator by Ovidio Villarreal
...
class Generator:
    def __init__(self, width=100, height=100, max_rooms=15, min_room_xy=5,
                 max_room_xy=20, rooms_overlap=True, random_connections=2,
                 random_spurs=3, tiles=MAP_TILES):
        self.width = width
        self.height = height
